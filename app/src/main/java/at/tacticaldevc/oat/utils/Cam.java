...
public class Cam {
    ...
    public static void configure(CameraCharacteristics characteristics) {
        ...
        //StreamConfigurationMap.getOutputFormats() RAW -> YUV -> JPEG
        ...
        CaptureRequest.Builder crb; //Google you know what? This is a really shitty builder. Thanks for nothing...
        try {
    ...
    public static Image takePicture() {
        while (!green_light) {
        } // I know this is dump but necessary
        try {
